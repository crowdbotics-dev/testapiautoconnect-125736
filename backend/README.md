...
## Project Structure
    ...
    ├── testapiautoconnect_125736  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_125736`
...
2. Clone this repo and `cd testapiautoconnect_125736`
